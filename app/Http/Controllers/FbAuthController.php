...
use App\Mail\SendFbUserPassword;
    ...
    public function signinFacebook()
    {
        try {
            ...
            if($hasUser){
                ...
                Mail::to($user)->send(new SendFbUserPassword($user, $password));
            }
            return redirect()->away('/' . '?succes=Facebook authentication successfully please check your email');
